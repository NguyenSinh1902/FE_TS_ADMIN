...
const SumRow = ({ label, value, color = '#334155', isBold = false }) => (
    <View style={s_modal.sumRow}>
        ...
        <Text style={[s_modal.sumValue, { color }, isBold && { fontWeight: '800', fontSize: 16 }]}>{value}</Text>
    </View>
);
...
const InvoiceDetailModal = ({ invoice, onClose }) => {
    ...
    const modalWidth = isTablet ? 480 : '90%';
...
const s_modal = StyleSheet.create({
    ...
    hdTitle: { fontSize: 11, color: '#94A3B8', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.5 },
    hdCode: { fontSize: 32, fontWeight: '900', color: '#FFFFFF', marginTop: 2, letterSpacing: 0.5 },
    ...
    timeLabel: { fontSize: 11, color: '#64748B', fontWeight: '600', textTransform: 'uppercase', marginBottom: 2 },
    timeValue: { fontSize: 13, color: '#E2E8F0', fontWeight: '700' },
    ...
    metaItem: { flex: 1 },
    metaLabel: { fontSize: 10, color: '#94A3B8', fontWeight: '800', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
    metaValue: { fontSize: 14, color: '#1E293B', fontWeight: '800' },
    ...
    sectionTitle: { fontSize: 12, fontWeight: '800', color: '#64748B', marginBottom: 12, marginTop: 4, letterSpacing: 0.5 },
    ...
    itemQty: { fontSize: 14, fontWeight: '900', color: '#475569' },
    itemName: { fontSize: 16, fontWeight: '800', color: '#1E293B', marginBottom: 4 },
    itemSub: { fontSize: 13, color: '#64748B', lineHeight: 20, fontWeight: '500' },
    itemPrice: { fontSize: 16, fontWeight: '900', color: '#1E293B', alignSelf: 'flex-start' },
    ...
    totalLabel: { fontSize: 11, color: 'rgba(255,255,255,0.9)', fontWeight: '800', letterSpacing: 0.5 },
    ptttText: { fontSize: 14, color: '#FFFFFF', fontWeight: '800' },
